...
ALL_PROVIDERS: list[ProviderDef] = [
    ...
    ProviderDef(
        ...
        description="NousResearch Free — inferência grátis",
    ...
    ProviderDef(
        ...
        name="OpenCode Go",
        model="deepseek-v4-flash",
        description="OpenCode Go — sub $10/mo",
        tiers=["low", "medium", "high"],
        tier_priority={"low": 0, "medium": 0, "high": 0},
        cost_display="$10/mo (sub)",
        cost_per_1k=0.0,
...
DISPLAY_ORDER = [
    ...
    "opencode_go", "nvidia", "nous", "deepseek",
]
